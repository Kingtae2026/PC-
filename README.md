...
카운터 PC, 사용자 PC, 키오스크를 하나의 TCP/IP 네트워크로 연결하여
...
세 개의 클라이언트가 카운터 PC 내장 TCP 서버를 중심으로 연결됩니다.

**사용자 PC - 카운터 PC 구성도**

![사용자PC 구성도](https://github.com/user-attachments/assets/bbdccc14-48d8-4e84-aaa3-d1774438578f)

**키오스크 - 카운터 PC 구성도**

![키오스크 구성도](https://github.com/user-attachments/assets/ad256660-6238-4012-81a8-2971f59e37a0)

| 포트 | 연결 대상 | 주요 역할 |
| :---: | :--- | :--- |
| **9000** | 사용자 PC ↔ 카운터 PC | 로그인 · 로그아웃 · 채팅 · 시간 동기화 |
| **9001** | 사용자 PC ↔ 카운터 PC | 음식 주문 처리 |
| **9002** | 키오스크 ↔ 카운터 PC | 회원가입 · 로그인 · 시간 충전 |
...
| 구성 요소 | 역할 요약 | 상세 문서 |
| :---: | :--- | :---: |
| **카운터 PC** | 서버 내장 · 좌석 현황 · 회원 · 주문 · 매출 관리 · 채팅 응답 | [바로가기](ADMIN.md) |
